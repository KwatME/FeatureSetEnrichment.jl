function plot_set_enrichment(
    ...
    y_annotation_template =
        merge(annotation_template, attr(x = -0.125, font_size = axis_title_font_size))
    ...
    set_enrichments, ks, auc =
        score_set(elements, element_values, set_elements_01; compute_cumulative_sum_ = true)
    ...
    return plot([element_values_trace, set_elements_trace, set_enrichments_trace], layout)
end
